  ...
  <div class="header">
    ...
    <div class="nav-container">
      <ul class="clearfix nav">
        <li class="nav-item">一个孤独用于演示的表格</li>
      </ul>
    </div>
    <!-- 个人中心 & 设置 -->
    <div class="user">
        ...
        this.$confirm('是否确认退出系统？', '提示', {
          ...
          this.$post('/logout').then((data) => {
            if (data === true) {
              ...
              this.localStore.remove("dictionary");
...
<style>
  ...
  .header .sidebar-control .icon:hover {
    font-size: 22px;
  ...
  .header .nav-container .nav {
    background: linear-gradient(to right, #01b2c2 , #1e74a3);
  }
  ...
  .header .user .item .icon.icon-x:hover {
    color: rgba(255, 255, 255, 0.8);
  }
  ...
  .header .user .v-line {
    ...
    top: 30%;
    width: 1px;
    background: rgba(112, 121, 255, 0.5);
  }
